...
subtitle: "Supporting Information File 3"
output: 
  html_notebook:
    theme: default
    highlight: haddock
...
d <- dall %>%
  mutate(comp= ifelse(antigen %in% c("vsp3","vsp5"),"Giardia\nVSP-5 (y-axis)\nVSP-3 (x-axis)",NA),
         ...
         comp= ifelse(antigen %in% c("sald","salb"),"Salmonella\nLPS Group D (y-axis)\nLPS Group B (x-axis)",comp),
         comp= ifelse(antigen %in% c("cholera","etec"),"ETEC toxin beta subunit (y-axis)\nV. cholerae toxin beta subunit (x-axis)",comp),
         comp= ifelse(antigen %in% c("norogi","norogii"),"Norovirus\nGI (y-axis)\nGII (x-axis)",comp),
         comp= ifelse(country=="Haiti" & antigen =="etec",NA,comp),
         comp= factor(comp,levels=c("Giardia\nVSP-5 (y-axis)\nVSP-3 (x-axis)","Cryptosporidium\nCp23 (y-axis)\nCp17 (x-axis)","Campylobacter\np39 (y-axis)\np18 (x-axis)","Salmonella\nLPS Group D (y-axis)\nLPS Group B (x-axis)","ETEC toxin beta subunit (y-axis)\nV. cholerae toxin beta subunit (x-axis)","Norovirus\nGI (y-axis)\nGII (x-axis)"))
         ) %>%
  filter(!is.na(comp))
...
# save a PDF version
ggsave(here("figs","all-ab-scatter-composite.pdf"),plot=complot,device="pdf",width=13,height=15)
...
# save a PDF version
pdf(here("figs","haiti-pairs-plot.pdf"),width=10,height=10)
pairs(hmat[mbavars],labels=mbalabs,cex=0.1,las=1,
      upper.panel=scatterloess,
      lower.panel=myellipse
)
...
# save a PDF version
pdf(here("figs","asembo-pairs-plot.pdf"),width=11,height=11)
pairs(kmat[mbavars],labels=mbalabs,cex=0.1,las=1,
      upper.panel=scatterloess,
      lower.panel=myellipse
)
...
# save a PDF version
pdf(here("figs","kongwa-pairs-plot.pdf"),width=11,height=11)
pairs(tmat[mbavars],labels=mbalabs,cex=0.1,las=1,
      upper.panel=scatterloess,
      lower.panel=myellipse
)
