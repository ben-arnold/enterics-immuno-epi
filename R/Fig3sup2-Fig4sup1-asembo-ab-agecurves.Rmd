...
subtitle: "Haiti age-dependent antibody curves, Figures 3-supp 2 and 4-supp 1"
output: 
  html_notebook:
    theme: default
    highlight: haddock
...
# Notebook Summary
This notebook estimates age-dependent mean antibody and seroprevalence curves in the Kenyan cohort. Estimators include cubic splines (in a GAM model from the `mgcv` package) and  ensemble machine learning (using stacked super learning from the `tmleAb` package).  Spline-based estimates are reported in the main text in Figures 3-supplement 2 and 4-supplement 1.
...
# drop cholera data, because of cross-reactivity with ETEC
