...
ppcurve2 <- ggplot(data=dplot,aes(x=age,color=antigenf,fill=antigenf)) +
  # approximate simultaneous CI from spline fit
  geom_ribbon(aes(ymin=lwrS,ymax=uprS),alpha=0.2,fill=cgrey,color=NA) +
  # actual measurements
  geom_point(aes(y=seropos),alpha=0.7,size=1.5,pch="|") +
  # spline fit
  geom_line(aes(y=fit),color="black") +
  # labels
...
ppcurve2 <- ggplot(data=dplot,aes(x=age,color=antigenf,fill=antigenf)) +
  ...
  geom_ribbon(aes(ymin=lwrS,ymax=uprS),alpha=0.2,color=NA,fill=cgrey) +
  # actual measurements
  geom_jitter(aes(y=seropos),width=0.2,height=0,alpha=0.4,size=1.5,pch="|") +
  # spline fit
  geom_line(aes(y=fit),color="black") +
  # labels
