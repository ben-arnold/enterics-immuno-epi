...
ggsave(file=here("figs","Fig6-asembo-seroincidence.pdf"),plot=ratep,device=cairo_pdf,height=8,width=4.5)
ggsave(file=here("figs","Fig6-asembo-seroincidence.TIFF"),plot=ratep,device="tiff",height=8,width=4.5)
