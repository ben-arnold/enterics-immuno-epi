...
p2 <- ggplot(data=dl,aes(x=logmfi,fill=pathogen,color=pathogen)) +
  ...
  scale_fill_manual(values=pcols)+
  # scale_fill_viridis_d(begin=0,end=0.9,option="plasma")+
...
ggsave(here("figs","Fig1-haiti-ab-distributions-byage.pdf"),plot=p2,device="pdf",width=16,height=6)
ggsave(here("figs","Fig1-haiti-ab-distributions-byage.TIFF"),plot=p2,device="tiff",width=16,height=6)
