...
#Summary
This script estimates age-dependent mean antibody curves using cubic splines (in a GAM model from the \code{mgcv} package) and using ensemble machine learning (using super learning from the \code{tmleAb} package). 
...
```{r age-curve mean figure, fig.height=8, fig.width=4}
...
```{r age-curve seroprevalence figure, fig.height=6, fig.width=4}
