...
ppcurve2 <- ggplot(data=filter(pgamfits,age<=17),aes(x=age,color=antigenf,fill=antigenf)) +
  # approximate simultaneous CI from spline fit
  geom_ribbon(aes(ymin=lwrS,ymax=uprS),alpha=0.2,color=NA) +
  # actual measurements
  geom_jitter(aes(y=seropos),width=0.2,height=0,color="black",alpha=0.4,size=0.3) +
...
# save a PDF version
ggsave("~/enterics-seroepi/figs/asembo-ab-agecurves-seroprev.pdf",plot=ppcurve2,device="pdf",width=7,height=14)
