...
# save a PDF version
ggsave("~/enterics-immuno-epi/figs/asembo-ab-agecurves-seroprev.pdf",plot=ppcurve2,device="pdf",width=7,height=14)
...
# save a PDF version
ggsave("~/enterics-immuno-epi/figs/asembo-ab-agecurves-seroprev-small.pdf",plot=ppcurve4,device="pdf",width=9,height=7)
