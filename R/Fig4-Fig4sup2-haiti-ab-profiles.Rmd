...
# save PDF and TIFF versions
ggsave(filename=here("figs","Fig4sup2-haiti-ab-trajectory-meas.pdf"),plot = sero_comp_p, device=cairo_pdf, width=5,height=12)
ggsave(filename=here("figs","Fig4sup2-haiti-ab-trajectories-meas.TIFF"),plot = sero_comp_p, device='tiff', width=5,height=12)
