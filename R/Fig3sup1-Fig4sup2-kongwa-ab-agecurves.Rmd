...
subtitle: "Tanzania age-dependent antibody curves, Figures 3-Sup1 and 4-Sup2"
output: 
  html_notebook:
    theme: default
    highlight: haddock
...
# Notebook Summary
This notebook estimates age-dependent mean antibody and seroprevalence curves in the Kongwa, Tanzania study. Estimators include cubic splines (in a GAM model from the `mgcv` package) and  ensemble machine learning (using stacked super learning from the `tmleAb` package).  Spline-based estimates are reported in the main text in Figures 3-supplement 1 and 4-supplement 2. 
