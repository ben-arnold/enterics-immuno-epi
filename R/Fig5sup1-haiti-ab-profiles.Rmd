...
subtitle: "Haiti antibody profiles, Figure 5 - supplement 1"
output: 
  html_document:
    highlight: haddock
    theme: default
...
ggsave(filename=here("figs","Fig5sup1-haiti-indiv-ab-trajectories-meas.pdf"),plot = indivp_meas2, device='pdf', width=6,height=12)
ggsave(filename=here("figs","Fig5sup1-haiti-indiv-ab-trajectories-meas.TIFF"),plot = indivp_meas2, device='tiff', width=6,height=12)
