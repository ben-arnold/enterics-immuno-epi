...
# save a PDF version
ggsave("~/enterics-immuno-epi/figs/kongwa-ab-agecurves-seroprev-allests.pdf",plot=ppcurve,device="pdf",width=4,height=10)
...
# save a PDF version
ggsave("~/enterics-immuno-epi/figs/kongwa-ab-agecurves-seroprev.pdf",plot=ppcurve2,device="pdf",width=4,height=10)
