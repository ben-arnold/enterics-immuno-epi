...
subtitle: Supplementary Information File 4. Estimation of force of infection assuming cross-sectional ("current status") data in Kenya. Figure 5 - supplement 1
output:
  html_document:
    highlight: haddock
    theme: default
...
```
#Figure 5 - supplement 1, FOI Comparison
...
ggsave(here("figs","Fig5sup1-asembo-ab-foi-comparison.pdf"),plot=ratecomp_plot,device=cairo_pdf,width=7.5,height=4)
ggsave(here("figs","Fig5sup1-asembo-ab-foi-comparison.TIFF"),plot=ratecomp_plot,device="tiff",width=7.5,height=4)
