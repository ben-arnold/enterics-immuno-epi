...
ggsave(file=here("figs","Fig6a-asembo-seroincidence.pdf"),plot=rateplot,device=cairo_pdf,height=2.4,width=8)
ggsave(file=here("figs","Fig6a-asembo-seroincidence.TIFF"),plot=rateplot,device="tiff",height=2.4,width=8)
