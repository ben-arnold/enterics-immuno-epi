...
#-----------------------------
ksim <- readRDS(here("output","asembo-imputation-simulation-results.rds")) %>%
  mutate(country = "Kenya")

hsim <- readRDS(here("output","haiti-imputation-simulation-results.rds")) %>%
  mutate(country = "Haiti")
...
ggsave(file=here("figs","Fig7a-asembo-foi-simulation.pdf"),plot=kplot_foi,device=cairo_pdf,height=4,width=8)
ggsave(file=here("figs","Fig7a-asembo-foi-simulation.TIFF"),plot=kplot_foi,device="tiff",height=4,width=8)
...
ggsave(file=here("figs","Fig7b-haiti-foi-simulation.pdf"),plot=hplot_foi,device=cairo_pdf,height=4,width=8)
ggsave(file=here("figs","Fig7b-haiti-foi-simulation.TIFF"),plot=hplot_foi,device="tiff",height=4,width=8)
