...
dl <- dl %>%
  mutate(pathogen = factor(pathogen,levels=c("Giardia","Cryptosporidium","E. histolytica","Rotavirus","ETEC","V. cholerae","Salmonella","Campylobacter")),
...
# analyses
#-----------------------------
saveRDS(dl,file="~/enterics-immuno-epi/data/asembo_analysis.rds")
```
# Session Info
```{r session info}
sessionInfo()
