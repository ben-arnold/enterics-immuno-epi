...
# save a PDF version
ggsave(here("figs","kongwa-ab-distributions.pdf"),plot=p,device="pdf",width=7,height=14)
...
# save a PDF version
ggsave(file=here("figs",paste("kongwa-ab-distributions-age-",i,".pdf",sep="")),plot=p,device="pdf",width=7,height=14)
}
...
mixcuts$mixcut[ !mixcuts$antigen %in% c("vsp3","vsp5","leca")] <- NA
...
plotmixdens <- mixdens %>%
  mutate(den1p = ifelse(!antigen %in% c("vsp3","vsp5","leca"),NA,den1),
         den2p = ifelse(!antigen %in% c("vsp3","vsp5","leca"),NA,den2)) %>%
...
# save a PDF version
ggsave(here("figs","kongwa-ab-mixture-distributions.pdf"),plot=pmix,device="pdf",width=7,height=14)

```

## Figure 1 - supp 2: age-stratified antibody distributions, with cutoffs
...
ggsave(here("figs","kongwa-ab-distributions-byage.pdf"),plot=p2,device="pdf",width=18,height=6)
