...
mbavars <- c("vsp3","vsp5","cp17","cp23","leca","p18","p39","etec","cholera","salb","sald")
...
# for Giardia and for E. hist LecA
...
pmix <- ggplot(data=filter(dl,age==1 & !antigen %in% c("p18","p39","salb","sald")),
  ...
  geom_line(data=plotmixdens,aes(x=x,y=den3p),color=cblack) +
...
knitr::kable(dclass,digits=2,caption="Summary of seropositivity classifications by ROC curve and Gaussian mixture models for Giardia (VSP-3 and VSP-5) and E. histolytica (LecA)")
