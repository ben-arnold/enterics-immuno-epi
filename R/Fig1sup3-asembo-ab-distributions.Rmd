...
mbalabs <- c("Giardia VSP-3","Giardia VSP-5","Cryptosporidium Cp17","Cryptosporidium Cp23","Salmonella LPS group B","Salmonella LPS group D","ETEC LT β subunit","Cholera toxin β subunit","Campylobacter p18","Campylobacter p39","E. histolytica LecA")
...
# save a PDF version
ggsave(here("figs","Fig1sup3-asembo-ab-distributions.pdf"),plot=pall,device=cairo_pdf,width=7,height=14)
