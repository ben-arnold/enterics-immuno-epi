...
subtitle: Kenya antibody profiles, Figure 4 - supplements 2 and 3
output: 
  html_document:
    highlight: haddock
    theme: default
...
ggsave(here("figs","Fig4sup2-asembo-ab-trajectories.pdf"),plot=pp2,device=cairo_pdf,width=5,height=10)
ggsave(here("figs","Fig4sup2-asembo-ab-trajectories.TIFF"),plot=pp2,device="tiff",width=5,height=10)
...
# save PDF and TIFF versions
ggsave(filename=here("figs","Fig4sup3-asembo-ab-trajectory-meas.pdf"),plot = sero_comp_p, device=cairo_pdf, width=5,height=10)
ggsave(filename=here("figs","Fig4sup3-asembo-ab-trajectories-meas.TIFF"),plot = sero_comp_p, device='tiff', width=5,height=10)
