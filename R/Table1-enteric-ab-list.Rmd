...
This notebook draws on datasets created by the notebooks that estimate antibody distributions in each cohort:
  * Haiti: haiti-enteric-ab-distributions.Rmd -> haiti_analysis2.rds
  * Kenya: asembo-enteric-ab-distributions.Rmd -> asembo_analysis2.rds
  * Tanzania: kongwa-enteric-ab-distributions.Rmd -> kongwa_analysis2.rds
...
knitr::kable(dtab,digits=2,escape=FALSE,
  ...
  group_rows("Asembo, Kenya", 11,22) %>%
  group_rows("Kongwa, Tanzania", 23,34) %>%
  footnote(
