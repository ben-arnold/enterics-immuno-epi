...
knitr::kable(dtab,digits=2,escape=FALSE,
             ...
             col.names=c("","N<br>children","N<br>samples","External<br>Reference","Mixture<br>Model","Unexposed")) %>%
