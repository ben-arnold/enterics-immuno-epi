...
dl2pp <- dl2 %>%
  ...
  mutate(
    ...
    sero_comp = ifelse(lead(seroi)==1 & lead(seroi4fold==1),"4-fold increase, across cutoff","<4-fold increase, across cutoff"),
    sero_comp = ifelse(lead(seroi)==0 & lead(seroi4fold==1),"4-fold increase, not across cutoff",sero_comp),
    sero_comp = ifelse(lead(seroi)==0 & lead(seroi4fold==0),"No seroconversion",sero_comp),
    sero_comp = factor(sero_comp,levels=c("4-fold increase, across cutoff","<4-fold increase, across cutoff","4-fold increase, not across cutoff","No seroconversion")),
...
```{r figure of individual MFI trajectories by age}
...
# save PDF version
ggsave(filename=here("figs","haiti-indiv-ab-age.pdf"),plot = indivp_age, device='pdf', width=5,height=14)
```

```{r figure of individual MFI trajectories by age compare class}
...
# save PDF version
ggsave(filename=here("figs","haiti-indiv-ab-age-comp.pdf"),plot = indivp_age, device='pdf', width=6,height=12)
```

```{r figure of individual MFI trajectories by measurement}
...
# save PDF version
ggsave(filename=here("figs","haiti-indiv-ab-measurement.pdf"),plot = indivp_meas, device='pdf', width=6,height=12)
```

```{r figure of individual MFI trajectories by measurement compare class}
# Individual trajectories by measurement (1 to 6)
# since only 29 children were measured 7+ times
...
# save PDF version
ggsave(filename=here("figs","haiti-indiv-ab-measurement-comp.pdf"),plot = indivp_meas2, device='pdf', width=6,height=12)
