...
subtitle: Haiti antibody profiles, Figure 4, Figure 4 - supplement 1
output: 
  html_document:
    highlight: haddock
    theme: default
...
ggsave(filename=here("figs","Fig4-haiti-indiv-ab-trajectories-meas.pdf"),plot = indivp_meas2, device=cairo_pdf, width=6,height=12)
ggsave(filename=here("figs","Fig4-haiti-indiv-ab-trajectories-meas.TIFF"),plot = indivp_meas2, device='tiff', width=6,height=12)
...
dl3 <- dl3 %>%
  ...
  arrange(antigenf,sero_comp,measnumf)
...
# save PDF and TIFF versions
ggsave(filename=here("figs","Fig4sup1-haiti-ab-trajectory-meas.pdf"),plot = sero_comp_p, device=cairo_pdf, width=5,height=12)
ggsave(filename=here("figs","Fig4sup1-haiti-ab-trajectories-meas.TIFF"),plot = sero_comp_p, device='tiff', width=5,height=12)
