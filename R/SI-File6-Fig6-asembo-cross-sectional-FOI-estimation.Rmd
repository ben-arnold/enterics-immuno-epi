...
subtitle: Supplementary Information File 6. Estimation of force of infection assuming cross-sectional ("current status") data in Kenya. Figure 6.
output:
  html_document:
    highlight: haddock
    theme: default
...
#--------------------------------
dsr <- readRDS(here("data","asembo_analysis2.rds"))
dsr <- dsr %>%
...
```{r incidence long xc comp figure,fig.width=10,fig.height=5}
...
ggsave(here("figs","Fig6-asembo-ab-foi-comparison.pdf"),plot=ratecomp_plot,device=cairo_pdf,width=10,height=4.5)
ggsave(here("figs","Fig6-asembo-ab-foi-comparison.TIFF"),plot=ratecomp_plot,device="tiff",width=10,height=4.5)
