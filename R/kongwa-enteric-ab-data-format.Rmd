...
mbavars <- c("vsp3","vsp5","cp17","cp23","etec","cholera","salb","sald","p18","p39","leca")

mbalabs <- c("Giardia VSP-3","Giardia VSP-5","Cryptosporidium Cp17","Cryptosporidium Cp23",
             "ETEC toxin beta subunit","Cholera toxin beta subunit","Salmonella LPS B","Salmonella LPS D","Campylobacter p18","Campylobacter p39","E. histolytica LecA")
...
dl <- dl %>%
  mutate(pathogen = factor(pathogen,levels=c("Giardia","Cryptosporidium","E. histolytica","ETEC","V. cholerae","Salmonella","Campylobacter")),
