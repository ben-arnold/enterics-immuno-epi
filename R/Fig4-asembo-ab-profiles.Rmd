...
subtitle: Asembo, Kenya antibody profiles, Figure 4
output:
  html_document:
    highlight: haddock
    theme: default
...
ggsave(here("figs","Fig4-asembo-ab-trajectories.pdf"),plot=pp2,device=cairo_pdf,width=6,height=10)
ggsave(here("figs","Fig4-asembo-ab-trajectories.TIFF"),plot=pp2,device="tiff",width=6,height=10)
