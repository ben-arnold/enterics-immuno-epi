...
ggsave(here("figs","Fig4sup1-asembo-ab-trajectories.pdf"),plot=pp2,device=cairo_pdf,width=5,height=10)
ggsave(here("figs","Fig4sup1-asembo-ab-trajectories.TIFF"),plot=pp2,device="tiff",width=5,height=10)
