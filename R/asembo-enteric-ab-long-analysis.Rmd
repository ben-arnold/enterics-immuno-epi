...
# Antibody distributions conditional on seroconversion status
...
# save a PDF version
ggsave(here("figs","asembo-ab-long-seroincidence-rate-ests.pdf"),plot=rateplot,device="pdf",width=5,height=5)
...
## Fig 6 - supp 1: sero incidence proportion
**This is Figure 6 - supplement 1 in the manuscript**
...
# save a PDF version
ggsave(here("figs","asembo-ab-long-seroincidence-ests.pdf"),plot=seroip,device="pdf",width=5,height=5)
